...
data_elb_cluster1 = data_set[:len(metrics_elb)] 
data_elb_cluster2 = data_set[len(metrics_elb):len(metrics_elb)*2] 
data_tg_cluster1 = data_set[len(metrics_elb)*2:len(metrics_elb)*2+len(metrics_tg)]  
data_tg_cluster2 = data_set[len(metrics_elb)*2+len(metrics_tg):] 
